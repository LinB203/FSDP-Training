...
def process_single_item(
    key, item, result_img_folder, origin_img_root, prompts, api_key, base_url
):
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Folder with subfolders of edited images",
    )
    parser.add_argument(
        "--edit_json",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Root path where original images are stored",
    )
    parser.add_argument(
        "--num_processes", type=int, default=32, help="Number of parallel threads"
    )
    parser.add_argument(
        "--prompts_json", type=str, required=True, help="JSON file containing prompts"
    )
    parser.add_argument(
        "--result_json", type=str, required=True, help="Path to output JSON file"
    )
    parser.add_argument(
